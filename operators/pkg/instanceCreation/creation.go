...
var hypervisorReserved float32 = 0.5
			...
			Domain: virtv1.DomainSpec{
				Resources: virtv1.ResourceRequirements{
					Requests: v1.ResourceList{
						"cpu":    template.Resources.ReservedCPU,
						"memory": template.Resources.Memory,
					},
					Limits: v1.ResourceList{
						"cpu":    resource.MustParse(ComputeCPULimits(template.Resources.CPUNumber, hypervisorReserved)),
						"memory": template.Resources.Memory,
					},
				},
				CPU: &virtv1.CPU{
					Cores: template.Resources.CPUNumber,
				},
